...
export default async function RebookPage() {
  ...
  // Phase 1 — parallel: client + sessions (no clientId dependency)
  ...
  // Phase 2 — parallel: everything that needs clientId
  const [
    lastMonthBookings,
  ...
  // Section 1: last-month pattern mapped to this month
  ...
  // Section 2: all other available slots this month

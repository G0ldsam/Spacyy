          ...
          <div className="mt-3 flex gap-2">
            {canInstall ? (
              <button
                ...
                disabled={installing}
                className="flex-1 py-2 bg-brand text-white text-sm font-semibold rounded-xl hover:bg-brand-dark transition-colors disabled:opacity-60"
              >
              ...
              <button
                ...
                className="flex-1 py-2 bg-brand text-white text-sm font-semibold rounded-xl hover:bg-brand-dark transition-colors flex items-center justify-center gap-1.5"
              >
